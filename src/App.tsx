          ...
          <Row gutter={16}>
              ...
              >
               ...
               {data.map((item, i) => {
                  return (
                      ...
                      <Row>
                      <Col span={8}>
                      <Checkbox value= {item['linkDefault']}> {item['linkDefault']}
                      <br/>
                      ...
                      <span className='space-align-container'>Số lần click: <b>{item['count'] + 4}</b></span>
                    </Card>
                    </>
                  );
                })}
            ...
            <Col span={16}  >
              ...
              <Card title="Detail Url" bordered={false} >
                   <b style={{fontSize:"1.5rem"}}>https://ant.design/components/modal/#header </b>
                   <h4>Time:02-07-2022 03:28:34</h4>
              ...
              <Input size="large"  value={"http://localhost:3000/4WRCyh"} prefix={<LinkOutlined onClick={onclickLink}/>} suffix={suffix}/>
              <br/>
              <br/>
              <DemoColumn />
